...
{
	$judul_situs = "Aplikasi Presensi";
}
if(! isset($deskripsi_situs))
{
	$deskripsi_situs = "Aplikasi Presensi merupakan Aplikasi untuk melakukan presensi dengan kartu pelajar pada SMAN 1 Lakbok";
}
...
<body>
	...
	<header>
		...
		<div class="menu">
			<ul>
				...
				<li class="menu-item hidden"><a href="/">Beranda</a></li>
				<li class="menu-item hidden">
					<a href="/">Presensi Masuk</a>
				</li>
				<li class="menu-item hidden">
					<a href="<?=base_url();?>/pulang">Presensi pulang</a>
				</li>
				<li class="menu-item hidden">
					<a href="https://www.sman1lakbok.sch.id" target="_blank">Web Utama</a>
				</li>
		...
		<div class="heroe">
			...
			<h1>PRESENSI HARIAN SMAN 1 LAKBOK</h1>
	...
	<footer>
		<div class="environment">
			...
			<p>Presensi SMAN 1 Lakbok</p>

		</div>

		<div class="copyrights">

			<p>&copy; <?= date('Y') ?> Dadan Setia</p>
